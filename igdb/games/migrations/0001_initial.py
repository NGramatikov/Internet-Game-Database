    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name',
                 models.CharField(max_length=100, unique=True, validators=[igdb.games.validators.validate_name])),
                ('description',
                 models.TextField(blank=True, null=True, validators=[django.core.validators.MinLengthValidator(20)])),
                ('type', models.CharField(choices=[('Party Games', 'Party Games'), ('Tabletop Games', 'Tabletop Games'),
                                                   ('Video Games', 'Video Games'), ('Other Games', 'Other Games')],
                                          default='Video Games', max_length=50)),
                ...
                ('chance', models.CharField(choices=[('Low', 'Low'), ('Medium', 'Medium'), ('High', 'High'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release_year', models.PositiveSmallIntegerField(
                    choices=[(1958, 1958), (1959, 1959), (1960, 1960), (1961, 1961), (1962, 1962), (1963, 1963),
                             (1964, 1964), (1965, 1965), (1966, 1966), (1967, 1967), (1968, 1968), (1969, 1969),
                             (1970, 1970), (1971, 1971), (1972, 1972), (1973, 1973), (1974, 1974), (1975, 1975),
                             (1976, 1976), (1977, 1977), (1978, 1978), (1979, 1979), (1980, 1980), (1981, 1981),
